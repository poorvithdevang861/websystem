    ...
    if data:
        ...
        # ---- POST confirm order ----
            ...
            if len(cart) == 0:
                ...
                cart.clear()
                content = "<h1>Order Placed Successfully</h1>"
        ...
        # ---- GET routes ----
            ...
            if base_path == "/":
                ...
                content += '<a href="/checkout">Go to Checkout</a>'

            elif base_path == "/checkout":
                if len(cart) == 0:
                    content = "<h1>Cart is Empty</h1>"
                else:
                    content = "<h1>Checkout</h1><ul>"
                    total = 0
                    ...
                    content += '<form method="POST" action="/confirm-order">'
                    content += '<button type="submit">Confirm Order</button>'
                    content += '</form>'
